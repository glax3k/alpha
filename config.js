...
module.exports = {
    ...
    BIONAME: process.env.BIO_NAME === undefined ? '━──🔥──╮• DigitalDrop •╭──🔥──━' : process.env.BIO_NAME,
    CL_KEY: process.env.COMMAND_LIST_KEY === undefined ? 'drop' : process.env.COMMAND_LIST_KEY,
